...
public class Player : MonoBehaviour
{
    ...
    private bool noChao = false;       // Indica se o personagem está tocando o chão (usado para permitir o pulo)
    ...
    void Update()
    {
        ...
        // Verifica se apertou espaço e se está no chão antes de permitir o pulo
    ...
    void OnCollisionEnter(Collision colisao)
    {
        ...
        {
            noChao = true; // Libera o pulo, pois o personagem está tocando o chão
        }
    }
    ...
    void OnCollisionExit(Collision colisao)
    {
        if (colisao.gameObject.CompareTag("Plataforma"))
        {
            noChao = false; // Bloqueia o pulo, pois o personagem saiu do chão 
        }
    }
}